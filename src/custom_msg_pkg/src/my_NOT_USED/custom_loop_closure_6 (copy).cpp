...
// LOOP CLOSURES
      ...
      // Timer 6-1
      timer61_ = this->create_wall_timer(
      50000ms, std::bind(&LoopClosurePublisher::timer61_callback, this));

      // Timer 6-2
      timer62_ = this->create_wall_timer(
      50000ms, std::bind(&LoopClosurePublisher::timer62_callback, this));

      // Timer 6-3
      timer63_ = this->create_wall_timer(
      50000ms, std::bind(&LoopClosurePublisher::timer63_callback, this));

      // Timer 6-4
      timer64_ = this->create_wall_timer(
      50000ms, std::bind(&LoopClosurePublisher::timer64_callback, this));

      // Timer 6-5
      timer65_ = this->create_wall_timer(
      50000ms, std::bind(&LoopClosurePublisher::timer65_callback, this));

      // Timer 6-7
      timer67_ = this->create_wall_timer(
      50000ms, std::bind(&LoopClosurePublisher::timer67_callback, this));

      // Timer 6-8
      timer68_ = this->create_wall_timer(
      50000ms, std::bind(&LoopClosurePublisher::timer68_callback, this));
    }
...
// LOOP CLOSURES FUNCTIONS
  ...
  private:
    void timer61_callback() const
    {
      ...
      dx = odom_1.odom.pose.pose.position.x - odom_6.odom.pose.pose.position.x;
      dy = odom_1.odom.pose.pose.position.y - odom_6.odom.pose.pose.position.y;
  ...
  private:
    void timer62_callback() const
    {
      ...
      dx = odom_2.odom.pose.pose.position.x - odom_6.odom.pose.pose.position.x;
      dy = odom_2.odom.pose.pose.position.y - odom_6.odom.pose.pose.position.y;
    ...
    void timer63_callback() const
    {
      ...
      dx = odom_3.odom.pose.pose.position.x - odom_6.odom.pose.pose.position.x;
      dy = odom_3.odom.pose.pose.position.y - odom_6.odom.pose.pose.position.y;
    ...
    void timer64_callback() const
    {
      ...
      dx = odom_4.odom.pose.pose.position.x - odom_6.odom.pose.pose.position.x;
      dy = odom_4.odom.pose.pose.position.y - odom_6.odom.pose.pose.position.y;
    ...
    void timer65_callback() const
    {
      ...
      dx = odom_5.odom.pose.pose.position.x - odom_6.odom.pose.pose.position.x;
      dy = odom_5.odom.pose.pose.position.y - odom_6.odom.pose.pose.position.y;
    ...
    void timer67_callback() const
    {
      ...
      dx = odom_7.odom.pose.pose.position.x - odom_6.odom.pose.pose.position.x;
      dy = odom_7.odom.pose.pose.position.y - odom_6.odom.pose.pose.position.y;
    ...
    rclcpp::TimerBase::SharedPtr timer61_;
    rclcpp::TimerBase::SharedPtr timer62_;
    rclcpp::TimerBase::SharedPtr timer63_;
    rclcpp::TimerBase::SharedPtr timer64_;
    rclcpp::TimerBase::SharedPtr timer65_;
    rclcpp::TimerBase::SharedPtr timer67_;
    rclcpp::TimerBase::SharedPtr timer68_;
