...
class OdomSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(Odometry, '/bot5/odom', self.add_noise_callback, 10)
          
        self.publisher_ = self.create_publisher(Odometry, '/bot5/noisy_odom', 10)
